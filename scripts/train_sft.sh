...
singularity exec --nv "$IMG" bash -lc '
  ...
  uv sync
  # uv run -m sft.train configs/sft/llama3_8b_instruct_dp_ep1.yaml
  # uv run -m sft.train configs/sft/llama3_8b_instruct_dp_ep3.yaml 
  # uv run -m sft.train configs/sft/llama3_8b_instruct_dp_ep5.yaml
  # uv run -m sft.train configs/sft/llama3_8b_instruct_dp_ep7.yaml
